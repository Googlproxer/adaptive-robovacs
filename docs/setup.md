...
To ignore a false-positive source, apply **robovac-exclude-occupancy** to its
device. The integration skips every motion or occupancy entity from a labelled
device, including entities that carry direct labels.
...
[v1.16.2 release notes](releases/v1.16.2.md). Oldest-completed-clean candidate
ordering is documented in the [v1.16.3 release notes](releases/v1.16.3.md).
